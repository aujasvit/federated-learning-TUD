...
from ..types import Augmentation, SamplableAugmentation
...
class SampledAugmentation(Augmentation):
    def __init__(self, augmentation: SamplableAugmentation, probability=0.8) -> None:
        assert isinstance(
            augmentation, SamplableAugmentation
        ), "Augmentation that should be sampled needs to be instance of SamplableAugmentation"
        self.augmentation: SamplableAugmentation = augmentation
