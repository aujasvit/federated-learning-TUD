...
this_dir = "/data/BCSS/"#os.path.split(__file__)

this_dir = "/gris/gris-f/homelv/adatta/work/FrOoDo/froodo/ood/augmentations/pathology/artifacts"
...
class ArtifactAugmentation:
    def transparentOverlay(
        ...
        scale=2,
        mask_threshold=0.3,
        overlay_path="/data/BCSS/dark_spots/small_spot.png",
        width_slack=(0.3, 0.3),
