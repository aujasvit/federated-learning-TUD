    ...
    def run(self,
        ...
        for epoch in tqdm(range(server_epochs)):
            ...
            for j in range(self.num_train_clients):
                ...
                if j in self.ana_clients:
                    new_model.load_state_dict(self._ana(new_model.state_dict()))
